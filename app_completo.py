...
# =============================================================================
# APLICAÇÃO COMPLETA v4: LEITURA DE LEGENDAS DE MÍDIA (API DIRETA DA META)
# =============================================================================
    ...
    if request.method == 'POST':
        ...
        try:
            if 'entry' in data and data['entry'][0]['changes'][0]['value'].get('messages'):
                ...
                # *** INÍCIO DA LÓGICA ATUALIZADA DE MÍDIA E LEGENDAS ***
...
# Endpoint para buscar e servir a mídia (sem alterações)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createMediaElement(msg) {
        ...
        // Se a mensagem tiver uma media_id, criamos o elemento de mídia
        if (msg.media_id) {
            ...
            // Adiciona a legenda se ela existir e for diferente do texto padrão
...
if __name__ == '__main__':
    print("===================================================")
    print("🚀 Servidor do Painel v4 (Modo Meta API) iniciado!")
